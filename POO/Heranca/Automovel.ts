...
export class Automovel extends Terrestre {
  ...
  constructor(capacidade: number, numeroRodas: number, velocidade: number, cor: string,
    numeroPortas: number, placa: string, marcha: number) {
  ...
  public mover(): void {
    console.log(`Automóvel está se locomovendo!`);
  }
